...
## 網站背景
還有個微小但重要的改動，我為全站設定了點點背景。  

不過就是個背景，有什麼好重要的？老實說考慮了很久要不要做，甚至在發布之前也考慮再三。畢竟我這個網站就是想要乾乾淨淨的，多了個背景，多少就是花俏了點，所以在視覺呈現上就更加小心翼翼。  

這個點點背景的來源是我以前常用的筆記本格式。常見的筆記本有橫線、方格等，我那時最喜歡用的則是點點，既能在寫字時提供參考線，又不會讓版面完全被格線主宰，可以在旁邊畫插圖或是寫大字等等。還記得那時候為了找好寫的點點筆記本，還費了一番功夫呢！因此也決定加到這裡來。  

### 實踐  
使用 CSS 的樣式 (background-image) 來做，就不用再弄個圖片另外連結。參數內容是 radial-gradient 也就是漸層功能，而不是一個實際的圓形物件。這點我覺得滿有趣的，想到我在做向量圖的時候，也有用過這招。  